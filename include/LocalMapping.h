...
public:
    ...
    list<pair<double,Eigen::Vector3f>> GetGlobalSensorPoses(Map* map, Eigen::Vector3f tbg, double originTs);
...
protected:
    ...
    Eigen::Matrix4f AlignGlobalFrame(const GlobalPosition::GlobalPosition* origin, list<const GlobalPosition::GlobalPosition*> gpsData, list<pair<double,Eigen::Vector3f>> framePosesData);
