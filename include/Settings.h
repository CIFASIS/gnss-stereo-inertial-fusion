...
namespace ORB_SLAM3 {
    ...
    public:
         ...
         */
        Settings(const std::string &configFile, const int& sensor, const bool useGlobalMeas);
        ...
        Eigen::Vector3f tbg() {return tbg_;}
    ...
    private:
        ...
        void readGlobalMeasurements(cv::FileStorage& fSettings);
