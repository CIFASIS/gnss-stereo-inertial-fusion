...
public:
    ...
    void SetFirstGlobalPos(Eigen::Vector3f firstGpsMeas);
    Eigen::Vector3f GetFirstGlobalPos();
    bool HasFirstGlobalPos();
    void SetKFRelatedToGlobalOrigin(KeyFrame* kf);
    void ClearKFRelatedToGlobalOrigin();
    KeyFrame* GetKFRelatedToGlobalOrigin();
    bool HasKFRelatedToGlobalOrigin();

    void SetGlobalVIOAlignment(Eigen::Matrix3f rotationAlignment);
    Eigen::Matrix3f GetGlobalVIOAlignment();
...
private:
    Eigen::Vector3f firstGlobalPos;
    KeyFrame* kfRelatedToGlobalOrigin;
    bool firstGlobalPosAvailable;
    bool kfRelatedToGlobalOriginAvailable;
    Eigen::Matrix3f globalVIOAlignment;
};
