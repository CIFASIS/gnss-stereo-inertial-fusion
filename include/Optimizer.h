...
public:
    ...
    void static LocalInertialBAWithGlobalMeas(KeyFrame* pKF, bool *pbStopFlag, Map *pMap, int& num_fixedKF, int& num_OptKF, int& num_MPs, int& num_edges, bool alignmentRotationFixed, bool bLarge = false, bool bRecInit = false);
    void static AlignmentRefinement(KeyFrame *pKF, bool *pbStopFlag, Map *pMap, int& num_fixedKF, int& num_OptKF, int& num_MPs, int& num_edges, bool alignmentRotationFixed, bool bLarge, bool bRecInit);
