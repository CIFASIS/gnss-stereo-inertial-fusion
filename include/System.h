...
public:
    ...
    Sophus::SE3f TrackStereo(const cv::Mat &imLeft, const cv::Mat &imRight, const double &timestamp, const vector<IMU::Point>& vImuMeas = vector<IMU::Point>(), const vector<const GlobalPosition::GlobalPosition*>& vGpsMeas = vector<const GlobalPosition::GlobalPosition*>(), string filename="");
    ...
    void Shutdown();
    bool isShutDown();
    bool forceSystemShutdown(bool localizationMode);
    ...
    void SaveMapPointsFromCurrentMap();
