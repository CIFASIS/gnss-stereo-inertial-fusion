...
#endif
            //std::cout << "Enter loop closing thread" << std::endl;

            /*if(mpLastMap && mpLastMap->isImuInitialized())
            {
                std::cout << "Start OptimizeGraphGlobalMeas()" << std::endl;
                Optimizer::OptimizeGraphGlobalMeas(mpLastMap);
            } */           
